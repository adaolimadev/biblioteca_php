...
<body>
    ...
    <div class="container bg-light">
        <div class ="row"> 
            <div class = "col mt-5">
                <h1 class="text-center" >Empréstimos Fechados</h1><br>
                <div class ="box-search">
                <a class ="btn btn-success" href="list_emprestimo.php">Ver Abertos</a> <br>
                    ...
                    <tbody> 
                        <?php 
                            ...
                            if(!empty($_GET['search'])){
                                $data = $_GET['search'];
                                $sql = "SELECT * FROM vwEmprestimos WHERE cod LIKE '%$data%' or nome_cliente LIKE '%$data%' or obs LIKE '%$data%' where status = 0;";
                            }else{
                                    $sql = "SELECT  * FROM  vwEmprestimos where status = 0 ORDER BY cod DESC;";
                            }
